export const projects = [
...

  {
    id: "3",
    icon: "/assets/github.svg",
    title: "Storefront API & website",
    desc: "Web store demo with Angular frontend and Express.JS backend. It allows users to browse a list of available products, add them to a cart, complete the checkout process and get an order confirmation.",
    img: "/assets/angular-store.png",
    github: "https://github.com/fmlog/storefront-api",
